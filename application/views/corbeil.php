<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><i class='fa fa-trash'></i> Corbeil</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                Dashboard
            </li>
            <li class="breadcrumb-item active">
                <strong>Corbeil</strong>
            </li>
        </ol>
    </div>
</div>
                ...
                <div class="ibox-content" style='padding: 15px'>
                    <div class='row'>
                        ...
                        <div class='col-9 text-right'>
                            <?php if(in_array(0, $this->session->userdata('privileges'))): ?>
            ...
            <div class="ibox ">
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table id='tableCorbeil' class="table table-bordered" >
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nature</th>
